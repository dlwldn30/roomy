...
public class UserUpdateRequest {
    ...
    public boolean isSnoring() { return snoring; }
    public CleaningCycle getCleaningCycle() { return cleaningCycle; }
    public DrinkingStyle getDrinkingStyle() { return drinkingStyle; }
    public boolean isBugKiller() { return bugKiller; }
    public Set<DayOfWeek> getAbsentDays() { return absentDays; }
    public String getHobby() { return hobby; }
    public String getSelfDescription() { return selfDescription; }
    public String getRoommateDescription() { return roommateDescription; }
}